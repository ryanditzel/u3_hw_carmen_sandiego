...
Select * FROM countrylanguage JOIN country ON countrylanguage.countrycode = country.code  WHERE language = 'Italian' and region = 'Southern Europe' and percentage = 100;
...
SELECT * FROM country JOIN city ON country.code = city.countrycode WHERE continent = 'South America' AND city.name ILIKE 'Serr%';
...
-- She's in ________SANTA_MONICA,_CA._USA____________________!
